# ZombieOrchard Render Audit: Exchange Result Render Readback Catch-Up
...
`exchange` currently falls through the generic screen path. It has no special projection branch and no retained readback row.

The recent `2026-07-09T16-34-14-04-00` render audit correctly identified this. This catch-up keeps that conclusion and points root/central ledgers at a complete tracker set.
...
```json
{
  ...
  "transactionCount": 0,
  "inventoryIntakeCount": 0,
  "sourceSnapshotVersion": "market-v1"
}
```
